...
<body class="m-0 bg- font-sans antialiased font-normal text-base leading-default bg-gray-50 text-slate-500">
    ...
    <div id="create-user" tabindex="-1" aria-hidden="true" style="position: absolute; z-index: 1060;"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" action="{{ route('usersMaster.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            ...
                            <input class="block w-full text-sm text-gray-900 border p-2 border-gray-300 rounded-lg cursor-pointer bg-gray-50 " id="multiple_files" name="avatar" type="file" multiple>
                        </div>
                        <div class="col-span-2">
    ...
    <div id="add-category" tabindex="-1" aria-hidden="true" style="position: absolute; z-index: 1060;"
        class="hidden overflow-y-auto overflow-x-hidden top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-md max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t">
                    <h3 class="text-lg font-semibold text-gray-900 ">
                        Create <span class="text-purple-500 to-purple-600">Category</span>
                    </h3>
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center"
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" action="{{ route('categories.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            <input type="text" name="name" id="category"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5"
                                placeholder="Type category" required="true">
                        </div>
                    </div>
                    <button type="submit"
                        class="text-white inline-flex items-center bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
