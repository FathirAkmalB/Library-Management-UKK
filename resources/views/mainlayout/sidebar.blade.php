<!-- sidenav  -->
<aside
    class="z-10 max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
    <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="" target="_blank">
            ...
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">WiseBook Library</span>
        </a>
    </div>

    <hr class="h-px mt-0 bg-transparent bg-gradient-to-r from-transparent via-black/40 to-transparent" />

    <div class="items-center block w-auto h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
                    ...
                    <a class="py-2.7  text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4   transition-colors"
                        ...
                        <div
                            ...
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                                ...
                                <title>shop</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-1716.000000, -439.000000)" fill="#000"
                                        fill-rule="nonzero">
                                        <g transform="translate(1716.000000, 291.000000)">
                                            <g transform="translate(0.000000, 148.000000)">
                                                <path class="opacity-60"
                                        ...
                                        <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF"
                                            ...
                                            <g transform="translate(1716.000000, 291.000000)">
                                                <g transform="translate(153.000000, 2.000000)">
                                                    <path class="fill-white opacity-60"
            ...
            {{-- Book Lend Start | Admin & Receptionist --}}
            @if (Auth::user()->role_id == 1 || Auth::user()->role_id == 2)
                @if (request()->is('bookLend*'))
                    <li class="mt-0.5 w-full">
                        <a class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors"
                            href="/bookLend">
                            <div
                            ...
                            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Book Lend</span>
                        </a>
                    </li>
                @else
                    <li class="mt-0.5 w-full">
            ...
            {{-- Book Master Start | Admin --}}
            @if (Auth::user()->role_id == 1)
                @if (request()->is('bookMaster*'))
                    <li class="mt-0.5 w-full">
                        <a class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors"
                            href="/bookMaster">
                            <div
                ...
                @endif
            @endif
            {{-- Book Master End | Admin --}}

            {{-- Rating & Review Start | Admin --}}
            @if (Auth::user()->role_id == 1)
                @if (request()->is('rating*'))
                    <li class="mt-0.5 w-full">
                        <a class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors"
                            ...
                            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Rating &
                                Review</span>
                        </a>
                    </li>
                @else
                ...
                @endif
            @endif
            {{-- Rating & Review End | Admin --}}


            {{-- History Lend Start | User --}}
            @if (Auth::user()->role_id == 3)
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Collection</span>
                    </a>
                </li>
            @else
                {{-- History Lend End | User --}}
            @endif
