                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans text-sm font-semibold leading-normal">Book Stock</p>
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div
                                    ...
                                    <i class="fa-solid fa-book-atlas text-lg relative top-3 text-white"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans text-sm font-semibold leading-normal">Book Lend</p>
                                    <h5 class="mb-0 font-bold">
                                        2,300
                                        <span class="text-sm leading-normal font-weight-bolder text-lime-500"></span>
                                    </h5>
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div
                                    class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500">
                                    <i class="fa-solid fa-clock text-lg relative top-3 text-white"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <p class="mb-0 font-sans text-sm font-semibold leading-normal">Book Categories</p>
                                    <h5 class="mb-0 font-bold">
                                        {{ $category }}
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div
                                    class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500">
                                    <i class="fa-solid fa-book text-lg relative top-3 text-white"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            ...
                            <div class="px-3 text-right basis-1/3">
                                <div
                                    class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500">
                                    <i class="fa-solid fa-users text-lg relative top-3 text-white"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="p-2  leading-normal text-center align-middle bg-transparent border-b whitespace-nowrap">
                                            <div class="w-3/4 mx-auto">
                                                <button type="button" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-xs px-3 py-1.5 text-center me-2 mb-2">Completed</button>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="p-2  leading-normal text-center align-middle bg-transparent border-b whitespace-nowrap">
                                            <div class="w-3/4 mx-auto">
                                                <button type="button" class="text-white bg-gradient-to-br from-pink-500 to-purple-800 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-xs px-3 py-1.5 text-center me-2 mb-2">Not Complete</button>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <div
                    ...
                    <div class="border-black/12.5 mb-0 rounded-t-2xl border-b-0 border-solid bg-white p-6 pb-0">
                        ...
                        <p class="text-sm leading-normal">
                            ...
                            <span class="font-semibold">12</span> this month
                        </p>
                    </div>
                    <div class="flex-auto p-4">
                        <div
                            ...
                            <div class="relative mb-4 mt-0 after:clear-both after:table after:content-['']">
                                <span
                                    ...
                                    <i
                                        class="relative z-10 leading-none text-transparent fa-regular fa-clock leading-pro bg-gradient-to-tl from-yellow-600 to-orange-400 bg-clip-text fill-transparent"></i>
                                </span>
                                <div class="ml-11.252 pt-1.4 lg:max-w-120 relative -top-1.5 w-auto">
                                    <h6 class="mb-0 text-sm font-semibold leading-normal text-slate-700">Username</h6>
